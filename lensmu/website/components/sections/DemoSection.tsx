...
export function DemoSection() {
  return (
    <section id="demo" className="bg-neutral-950 text-white section-padding">
      <div className="section-shell">
        ...
        <div className="mx-auto mt-12 max-w-6xl">
          <div className="overflow-hidden rounded-lg border border-white/20 bg-white/10 shadow-lift">
            ...
            <div className="relative aspect-video">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                <a
                  href="/contact"
                  className="mb-5 inline-flex h-16 w-16 items-center justify-center rounded-md bg-white text-neutral-950 shadow-soft transition-transform hover:scale-105"
